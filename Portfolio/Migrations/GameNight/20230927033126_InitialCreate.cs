    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GameNightMeals", x => x.Id);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GameNightGameNightGame", x => new { x.GameNightId, x.GamesId });
                    table.ForeignKey(
                        name: "FK_GameNightGameNightGame_GameNights_GameNightId",
                        column: x => x.GameNightId,
                        principalTable: "GameNights",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GameNightGameNightGame_Games_GamesId",
                        column: x => x.GamesId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GameNights_GameNightMealId",
                table: "GameNights",
                column: "GameNightMealId");
